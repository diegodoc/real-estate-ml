...
class OlxApiCollector:
    def __init__(self):
        ...
        self.regions = {"pernambuco": "81", "recife": "3744", "boa_viagem": "29748"}

        # Property category IDs
        self.categories = {"aluguel": "1020"}
    ...
    def get_api_response(self, list_id, region_id="81", category_id="1020"):
        ...
        try:
            ...
            response = cureq.get(url, params=params, headers=headers, impersonate="chrome110")
    ...
    def extract_listings_from_response(self, response_data):
        ...
        try:
            ...
            logger.info(
                f"Extracted {len(listings)} new real estate listings (filtered out non-real estate items)"
            )
            return listings
        except Exception as e:
    ...
    def get_search_results(self, page=1, state="pe", region_id="81"):
        ...
        try:
            ...
            # Make the request
            response = cureq.get(
                search_url, params=params, headers=self.headers, impersonate="chrome110"
            )
...
if __name__ == "__main__":
    # Configure logger
    logger.add(
        "c:/Users/Diego/Documents/Projetos/Python/real-estate-ml/real-estate-ml/logs/olx_collector_{time}.log"
    )
