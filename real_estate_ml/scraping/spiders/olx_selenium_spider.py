...
class OlxSeleniumSpider(BaseSeleniumSpider):
    ...
    def safe_get(self, url):
        ...
        try:
            ...
            # Check for blocking
            if any(x in self.driver.page_source.lower() for x in ["403", "blocked", "captcha", "security check"]):
    ...
    def take_screenshot(self, filename):
        ...
        try:
            ...
            screenshots_dir = Path("c:/Users/Diego/Documents/Projetos/Python/real-estate-ml/real-estate-ml/debug")
        ...
        for url in self.start_urls:
            ...
            if self.safe_get(url):
                ...
                try:
                    ...
                    cookie_buttons = self.driver.find_elements(By.CSS_SELECTOR, "button[data-testid='cookie-policy-accept-all']")
                    if cookie_buttons:
        ...
        try:
            ...
            if next_button and next_button[0].is_enabled():
                ...
                if next_url and next_url != self.driver.current_url:
                    ...
                    if self.wait_for_element(By.CSS_SELECTOR, "[data-testid='listing-main']", timeout=20):
                        return True
                    else:
    ...
    def parse_ad(self):
        ...
        description_elem = self.wait_for_element(By.CSS_SELECTOR, "div[data-testid='ad-description']")
        ...
        # Publication date
        published_date_elem = self.wait_for_element(By.CSS_SELECTOR, "span[data-testid='ad-posted-date']")
        ...
        # Extract details
        details = {}
        detail_sections = self.driver.find_elements(By.CSS_SELECTOR, "div[data-testid='ad-properties']")
        
        if detail_sections:
            detail_items = detail_sections[0].find_elements(By.CSS_SELECTOR, "div[data-testid='ad-property']")
            for detail in detail_items:
                # Each property has a label and value
                label_elem = detail.find_element(By.CSS_SELECTOR, "div[data-testid='ad-property-label']")
                value_elem = detail.find_element(By.CSS_SELECTOR, "div[data-testid='ad-property-value']")
        ...
        seller_since_elem = self.wait_for_element(By.CSS_SELECTOR, "div[data-testid='seller-member-since']")
